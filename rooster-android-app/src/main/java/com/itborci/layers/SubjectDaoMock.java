...
class SubjectDaoMock implements SubjectDao {
    ...
    static {
        ...
        listMonday =
                ...
                Subject.create(id++, "ZTGB", "T-207", "Ambrož", 0, 0, 2, 2, color1, false)
        )
        );
        ...
        listTuesday = Collections.unmodifiableList(Arrays.asList(
                ...
                Subject.create(id++, "MOPR", "T-014", "Borovička", 0, 1, 2, 2, color2, false),
                Subject.create(id++, "MOPRcv", "T-014", "Borovička", 0, 1, 3, 3, color2, true),
        ...
        listWednesday = Collections.unmodifiableList(Arrays.asList(
                ...
                Subject.create(id++, "MOPR", "T-014", "Borovička", 0, 2, 2, 2, color2, false),
                Subject.create(id++, "MOPRcv", "T-014", "Borovička", 0, 2, 3, 3, color2, true),
